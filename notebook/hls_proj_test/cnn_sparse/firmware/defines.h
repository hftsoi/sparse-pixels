...
typedef ap_ufixed<3,2> conv1_bias_t;
typedef ap_ufixed<14,6> conv1_relu_t;
typedef ap_ufixed<18,6> pool1_accum_t;
typedef ap_fixed<10,2> pool1_t;
typedef ap_fixed<9,2> conv2_iq_t;
typedef ap_fixed<15,7> conv2_accum_t;
typedef ap_fixed<15,7> conv2_t;
typedef ap_fixed<4,3> conv2_weight_t;
typedef ap_ufixed<4,0> conv2_bias_t;
typedef ap_ufixed<14,6> conv2_relu_t;
typedef ap_ufixed<16,6> pool2_accum_t;
typedef ap_ufixed<16,6> pool2_t;
...
typedef ap_fixed<4,1> dense1_bias_t;
