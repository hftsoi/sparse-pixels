...
void dense1_iq(input_t *inp, output_t *out) {
    ...
    out[27] = ap_fixed<4,3,AP_RND,AP_WRAP>(inp[27]);
    ...
    out[44] = ap_fixed<5,3,AP_RND,AP_WRAP>(inp[44]);
    ...
    out[49] = ap_fixed<3,2,AP_RND,AP_WRAP>(inp[49]);
    ...
    out[62] = ap_fixed<5,3,AP_RND,AP_WRAP>(inp[62]);
    out[63] = ap_fixed<4,3,AP_RND,AP_WRAP>(inp[63]);
    out[64] = ap_fixed<4,3,AP_RND,AP_WRAP>(inp[64]);
    ...
    out[68] = ap_fixed<4,3,AP_RND,AP_WRAP>(inp[68]);
    ...
    out[75] = ap_fixed<4,3,AP_RND,AP_WRAP>(inp[75]);
    out[76] = ap_fixed<3,2,AP_RND,AP_WRAP>(inp[76]);
    out[77] = ap_fixed<3,2,AP_RND,AP_WRAP>(inp[77]);
    out[78] = ap_fixed<4,3,AP_RND,AP_WRAP>(inp[78]);
    out[79] = ap_fixed<5,3,AP_RND,AP_WRAP>(inp[79]);
    out[80] = ap_fixed<5,3,AP_RND,AP_WRAP>(inp[80]);
    out[81] = ap_fixed<3,2,AP_RND,AP_WRAP>(inp[81]);
    out[82] = ap_fixed<4,3,AP_RND,AP_WRAP>(inp[82]);
    out[83] = ap_fixed<5,3,AP_RND,AP_WRAP>(inp[83]);
    out[84] = ap_fixed<2,0,AP_RND,AP_WRAP>(inp[84]);
    out[85] = ap_fixed<2,1,AP_RND,AP_WRAP>(inp[85]);
...
void dense2_iq(input_t *inp, output_t *out) {
    ...
    out[16] = ap_fixed<6,4,AP_RND,AP_WRAP>(inp[16]);
    ...
    out[20] = ap_fixed<5,4,AP_RND,AP_WRAP>(inp[20]);
    ...
    out[26] = ap_fixed<7,5,AP_RND,AP_WRAP>(inp[26]);
    ...
    out[35] = ap_fixed<7,5,AP_RND,AP_WRAP>(inp[35]);
}
