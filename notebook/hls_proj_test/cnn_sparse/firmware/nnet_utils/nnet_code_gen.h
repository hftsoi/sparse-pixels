...
void dense1_iq(input_t *inp, output_t *out) {
    ...
    out[22] = ap_fixed<4,3,AP_RND,AP_WRAP>(inp[22]);
    out[23] = ap_fixed<3,2,AP_RND,AP_WRAP>(inp[23]);
    out[24] = ap_fixed<4,3,AP_RND,AP_WRAP>(inp[24]);
    ...
    out[32] = ap_fixed<4,2,AP_RND,AP_WRAP>(inp[32]);
    ...
    out[42] = ap_fixed<6,4,AP_RND,AP_WRAP>(inp[42]);
    ...
    out[50] = ap_fixed<3,2,AP_RND,AP_WRAP>(inp[50]);
    ...
    out[65] = ap_fixed<5,3,AP_RND,AP_WRAP>(inp[65]);
    ...
    out[86] = ap_fixed<2,0,AP_RND,AP_WRAP>(inp[86]);
...
void dense2_iq(input_t *inp, output_t *out) {
    ...
    out[4] = ap_fixed<5,4,AP_RND,AP_WRAP>(inp[4]);
    out[5] = ap_fixed<5,3,AP_RND,AP_WRAP>(inp[5]);
    ...
    out[11] = ap_fixed<4,3,AP_RND,AP_WRAP>(inp[11]);
    out[12] = ap_fixed<4,3,AP_RND,AP_WRAP>(inp[12]);
    out[13] = ap_fixed<6,4,AP_RND,AP_WRAP>(inp[13]);
    out[14] = ap_fixed<6,4,AP_RND,AP_WRAP>(inp[14]);
    ...
    out[19] = ap_fixed<6,5,AP_RND,AP_WRAP>(inp[19]);
    out[20] = ap_fixed<7,5,AP_RND,AP_WRAP>(inp[20]);
    ...
    out[26] = ap_fixed<6,4,AP_RND,AP_WRAP>(inp[26]);
    out[27] = ap_fixed<5,4,AP_RND,AP_WRAP>(inp[27]);
    out[28] = ap_fixed<5,4,AP_RND,AP_WRAP>(inp[28]);
    out[29] = ap_fixed<6,4,AP_RND,AP_WRAP>(inp[29]);
    out[30] = ap_fixed<5,3,AP_RND,AP_WRAP>(inp[30]);
    ...
    out[34] = ap_fixed<5,3,AP_RND,AP_WRAP>(inp[34]);
    out[35] = ap_fixed<5,4,AP_RND,AP_WRAP>(inp[35]);
}
