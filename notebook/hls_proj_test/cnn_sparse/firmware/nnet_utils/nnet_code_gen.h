...
void conv2_iq(input_t *inp, output_t *out) {
    ...
    out[0] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[0]);
    out[1] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[1]);
    out[2] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[2]);
    out[3] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[3]);
    out[4] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[4]);
    out[5] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[5]);
    out[6] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[6]);
    out[7] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[7]);
    out[8] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[8]);
    out[9] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[9]);
    out[10] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[10]);
    out[11] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[11]);
    out[12] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[12]);
    out[13] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[13]);
    out[14] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[14]);
    out[15] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[15]);
    out[16] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[16]);
    out[17] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[17]);
    out[18] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[18]);
    out[19] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[19]);
    out[20] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[20]);
    out[21] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[21]);
    out[22] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[22]);
    out[23] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[23]);
    out[24] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[24]);
    out[25] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[25]);
    out[26] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[26]);
    out[27] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[27]);
    out[28] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[28]);
    out[29] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[29]);
    out[30] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[30]);
    out[31] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[31]);
    out[32] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[32]);
    out[33] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[33]);
    out[34] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[34]);
    out[35] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[35]);
    out[36] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[36]);
    out[37] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[37]);
    out[38] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[38]);
    out[39] = ap_fixed<8,1,AP_RND,AP_WRAP>(inp[39]);
}
...
void dense1_iq(input_t *inp, output_t *out) {
    ...
    out[21] = ap_fixed<3,2,AP_RND,AP_WRAP>(inp[21]);
    ...
    out[40] = ap_fixed<3,3,AP_RND,AP_WRAP>(inp[40]);
    out[41] = ap_fixed<4,3,AP_RND,AP_WRAP>(inp[41]);
    out[42] = ap_fixed<5,4,AP_RND,AP_WRAP>(inp[42]);
    out[43] = ap_fixed<5,4,AP_RND,AP_WRAP>(inp[43]);
    out[44] = ap_fixed<5,4,AP_RND,AP_WRAP>(inp[44]);
    out[45] = ap_fixed<6,4,AP_RND,AP_WRAP>(inp[45]);
    out[46] = ap_fixed<5,4,AP_RND,AP_WRAP>(inp[46]);
    out[47] = ap_fixed<5,4,AP_RND,AP_WRAP>(inp[47]);
    out[48] = ap_fixed<4,3,AP_RND,AP_WRAP>(inp[48]);
    ...
    out[57] = ap_fixed<4,3,AP_RND,AP_WRAP>(inp[57]);
    out[58] = ap_fixed<4,3,AP_RND,AP_WRAP>(inp[58]);
    out[59] = ap_fixed<4,3,AP_RND,AP_WRAP>(inp[59]);
    out[60] = ap_fixed<5,4,AP_RND,AP_WRAP>(inp[60]);
    out[61] = ap_fixed<5,4,AP_RND,AP_WRAP>(inp[61]);
    out[62] = ap_fixed<5,4,AP_RND,AP_WRAP>(inp[62]);
    out[63] = ap_fixed<5,4,AP_RND,AP_WRAP>(inp[63]);
    out[64] = ap_fixed<6,4,AP_RND,AP_WRAP>(inp[64]);
    out[65] = ap_fixed<6,4,AP_RND,AP_WRAP>(inp[65]);
    out[66] = ap_fixed<4,3,AP_RND,AP_WRAP>(inp[66]);
    out[67] = ap_fixed<3,2,AP_RND,AP_WRAP>(inp[67]);
    ...
    out[76] = ap_fixed<4,2,AP_RND,AP_WRAP>(inp[76]);
    out[77] = ap_fixed<4,3,AP_RND,AP_WRAP>(inp[77]);
    out[78] = ap_fixed<5,3,AP_RND,AP_WRAP>(inp[78]);
    out[79] = ap_fixed<4,2,AP_RND,AP_WRAP>(inp[79]);
    out[80] = ap_fixed<5,3,AP_RND,AP_WRAP>(inp[80]);
    out[81] = ap_fixed<5,3,AP_RND,AP_WRAP>(inp[81]);
    out[82] = ap_fixed<5,3,AP_RND,AP_WRAP>(inp[82]);
    out[83] = ap_fixed<4,2,AP_RND,AP_WRAP>(inp[83]);
    out[84] = ap_fixed<2,1,AP_RND,AP_WRAP>(inp[84]);
...
void dense2_iq(input_t *inp, output_t *out) {
    ...
    out[1] = ap_fixed<5,4,AP_RND,AP_WRAP>(inp[1]);
    out[2] = ap_fixed<6,5,AP_RND,AP_WRAP>(inp[2]);
    out[3] = ap_fixed<6,4,AP_RND,AP_WRAP>(inp[3]);
    out[4] = ap_fixed<6,5,AP_RND,AP_WRAP>(inp[4]);
    ...
    out[10] = ap_fixed<5,4,AP_RND,AP_WRAP>(inp[10]);
    out[11] = ap_fixed<5,4,AP_RND,AP_WRAP>(inp[11]);
    out[12] = ap_fixed<5,4,AP_RND,AP_WRAP>(inp[12]);
    out[13] = ap_fixed<5,4,AP_RND,AP_WRAP>(inp[13]);
    ...
    out[17] = ap_fixed<5,4,AP_RND,AP_WRAP>(inp[17]);
    out[18] = ap_fixed<5,4,AP_RND,AP_WRAP>(inp[18]);
    out[19] = ap_fixed<5,4,AP_RND,AP_WRAP>(inp[19]);
    out[20] = ap_fixed<6,4,AP_RND,AP_WRAP>(inp[20]);
    out[21] = ap_fixed<5,4,AP_RND,AP_WRAP>(inp[21]);
    out[22] = ap_fixed<5,4,AP_RND,AP_WRAP>(inp[22]);
    out[23] = ap_fixed<6,5,AP_RND,AP_WRAP>(inp[23]);
    out[24] = 0;
    out[25] = ap_fixed<5,4,AP_RND,AP_WRAP>(inp[25]);
    out[26] = ap_fixed<5,4,AP_RND,AP_WRAP>(inp[26]);
    out[27] = ap_fixed<6,4,AP_RND,AP_WRAP>(inp[27]);
    out[28] = ap_fixed<6,4,AP_RND,AP_WRAP>(inp[28]);
    out[29] = ap_fixed<6,4,AP_RND,AP_WRAP>(inp[29]);
    out[30] = ap_fixed<6,4,AP_RND,AP_WRAP>(inp[30]);
    out[31] = ap_fixed<4,3,AP_RND,AP_WRAP>(inp[31]);
    out[32] = ap_fixed<6,4,AP_RND,AP_WRAP>(inp[32]);
    out[33] = ap_fixed<5,4,AP_RND,AP_WRAP>(inp[33]);
    out[34] = ap_fixed<4,3,AP_RND,AP_WRAP>(inp[34]);
