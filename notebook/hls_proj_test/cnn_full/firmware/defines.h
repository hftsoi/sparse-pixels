...
typedef ap_fixed<15,6> conv1_accum_t;
typedef ap_fixed<15,6> conv1_t;
typedef ap_fixed<5,3> conv1_weight_t;
typedef ap_ufixed<2,32> conv1_bias_t;
typedef ap_ufixed<14,5> conv1_relu_t;
typedef ap_fixed<18,8> conv1_relu_table_t;
typedef ap_ufixed<22,9> pool1_accum_t;
typedef ap_fixed<9,3> pool1_t;
typedef ap_fixed<8,3> conv2_iq_t;
typedef ap_fixed<14,8> conv2_accum_t;
typedef ap_fixed<14,8> conv2_t;
typedef ap_fixed<4,3> conv2_weight_t;
typedef ap_ufixed<2,32> conv2_bias_t;
typedef ap_ufixed<13,7> conv2_relu_t;
typedef ap_fixed<18,8> conv2_relu_table_t;
typedef ap_ufixed<17,9> pool2_accum_t;
