...
typedef ap_fixed<7,3> pool1_t;
typedef ap_fixed<6,3> conv2_iq_t;
typedef ap_fixed<12,8> conv2_accum_t;
typedef ap_fixed<12,8> conv2_t;
typedef ap_fixed<4,3> conv2_weight_t;
typedef ap_ufixed<2,-1> conv2_bias_t;
typedef ap_ufixed<11,7> conv2_relu_t;
typedef ap_fixed<18,8> conv2_relu_table_t;
typedef ap_ufixed<15,9> pool2_accum_t;
typedef ap_fixed<8,5> pool2_t;
typedef ap_fixed<7,5> dense1_iq_t;
typedef ap_fixed<14,9> dense1_accum_t;
