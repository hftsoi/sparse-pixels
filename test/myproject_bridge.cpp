...
void myproject_float(
    ...
    result_t layer11_out_ap[N_LAYER_11];

    myproject(input_1_ap,layer11_out_ap);

    nnet::convert_data<result_t, float, N_LAYER_11>(layer11_out_ap, layer11_out);
}

void myproject_double(
    double input_1[N_INPUT_1_1*N_INPUT_2_1*N_INPUT_3_1],
    double layer11_out[N_LAYER_11]
) {
    ...
    nnet::convert_data<result_t, double, N_LAYER_11>(layer11_out_ap, layer11_out);
}
}
