...
typedef nnet::array<ap_ufixed<16,6,AP_RND_CONV,AP_SAT,0>, 1*1> layer20_t;
typedef ap_fixed<39,20> conv2_accum_t;
typedef nnet::array<ap_fixed<39,20>, 1*1> conv2_result_t;
typedef ap_fixed<16,7> weight5_t;
typedef ap_fixed<16,7> bias5_t;
typedef nnet::array<ap_ufixed<16,6,AP_RND_CONV,AP_SAT,0>, 1*1> layer7_t;
typedef ap_fixed<18,8> relu2_table_t;
typedef nnet::array<ap_ufixed<16,6,AP_RND_CONV,AP_SAT,0>, 1*1> layer21_t;
typedef ap_fixed<39,20> conv3_accum_t;
typedef nnet::array<ap_fixed<39,20>, 4*1> conv3_result_t;
typedef ap_fixed<16,7> weight8_t;
typedef ap_fixed<16,7> bias8_t;
typedef nnet::array<ap_ufixed<16,6,AP_RND_CONV,AP_SAT,0>, 4*1> layer10_t;
typedef ap_fixed<18,8> relu3_table_t;
typedef ap_ufixed<28,12> pool1_accum_t;
typedef nnet::array<ap_ufixed<16,6,AP_RND_CONV,AP_SAT,0>, 4*1> layer11_t;
typedef ap_fixed<41,22> dense1_accum_t;
typedef nnet::array<ap_fixed<41,22>, 12*1> dense1_result_t;
typedef ap_fixed<16,7> weight13_t;
typedef ap_fixed<16,7> bias13_t;
typedef ap_uint<1> layer13_index;
typedef nnet::array<ap_ufixed<16,6,AP_RND_CONV,AP_SAT,0>, 12*1> layer15_t;
typedef ap_fixed<18,8> relu4_table_t;
typedef ap_fixed<27,18> dense2_accum_t;
typedef nnet::array<ap_fixed<27,18>, 1*1> dense2_result_t;
