...
typedef nnet::array<ap_ufixed<16,6,AP_RND_CONV,AP_SAT,0>, 1*1> layer17_t;
typedef ap_fixed<39,20> conv2_accum_t;
typedef nnet::array<ap_fixed<39,20>, 3*1> conv2_result_t;
typedef ap_fixed<16,7> weight5_t;
typedef ap_fixed<16,7> bias5_t;
typedef nnet::array<ap_ufixed<16,6,AP_RND_CONV,AP_SAT,0>, 3*1> layer7_t;
...
typedef nnet::array<ap_fixed<41,22>, 16*1> dense1_result_t;
typedef ap_fixed<16,7> weight10_t;
typedef ap_fixed<16,7> bias10_t;
typedef ap_uint<1> layer10_index;
typedef nnet::array<ap_ufixed<16,6,AP_RND_CONV,AP_SAT,0>, 16*1> layer12_t;
typedef ap_fixed<18,8> relu3_table_t;
typedef ap_fixed<27,10> dense2_accum_t;
typedef nnet::array<ap_fixed<27,10>, 1*1> dense2_result_t;
