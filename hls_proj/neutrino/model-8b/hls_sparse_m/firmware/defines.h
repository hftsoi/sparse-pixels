...
typedef ap_fixed<23,8> conv2_result_t;
...
typedef ap_fixed<23,8> conv3_result_t;
...
typedef ap_fixed<25,10> dense1_result_t;
...
typedef ap_fixed<21,6> dense2_result_t;
...
typedef ap_ufixed<8,0,AP_RND_CONV,AP_SAT,0> conv_default_t;
typedef ap_ufixed<8,0,AP_RND_CONV,AP_SAT,0> model_default_t;
