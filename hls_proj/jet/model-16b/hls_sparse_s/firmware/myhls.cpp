...
void myhls(
    ...
    sparse_conv<input_t, conv_default_t, ap_uint<10>, weight2_t, bias2_t, N_MAX_PIXELS, 1, 3, 9>(sparse_arr_feat_reduce_out, sparse_arr_feat_conv1_out, sparse_arr_hash_reduce_out, w2, b2); // sparse conv1
    ...
    sparse_conv<model_default_t, conv_default_t, ap_uint<10>, weight5_t, bias5_t, N_MAX_PIXELS, 3, 1, 9>(sparse_arr_feat_act1_out, sparse_arr_feat_conv2_out, sparse_arr_hash_reduce_out, w5, b5); // sparse conv2
    ...
    sparse_pooling_avg<model_default_t, model_default_t, ap_uint<10>, N_MAX_PIXELS, 1, 4>(sparse_arr_feat_act2_out, sparse_arr_feat_pool1_out, sparse_arr_hash_reduce_out, sparse_arr_hash_pool1_out); // sparse pool2

    model_default_t flatten_out[14 * 14 * 1];
    #pragma HLS ARRAY_PARTITION variable=flatten_out complete dim=0
    sparse_flatten<model_default_t, ap_uint<10>, 14, 14, 1, N_MAX_PIXELS>(sparse_arr_feat_pool1_out, sparse_arr_hash_pool1_out, flatten_out); // sparse flatten
