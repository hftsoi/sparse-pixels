...
typedef nnet::array<ap_fixed<38,19>, 3*1> conv1_result_t;
...
typedef nnet::array<ap_ufixed<16,6,AP_RND_CONV,AP_SAT,0>, 3*1> layer20_t;
typedef ap_fixed<40,21> conv2_accum_t;
typedef nnet::array<ap_fixed<40,21>, 2*1> conv2_result_t;
typedef ap_fixed<16,7> weight5_t;
typedef ap_fixed<16,7> bias5_t;
typedef nnet::array<ap_ufixed<16,6,AP_RND_CONV,AP_SAT,0>, 2*1> layer7_t;
typedef ap_fixed<18,8> relu2_table_t;
typedef nnet::array<ap_ufixed<16,6,AP_RND_CONV,AP_SAT,0>, 2*1> layer21_t;
typedef ap_fixed<39,20> conv3_accum_t;
typedef nnet::array<ap_fixed<39,20>, 1*1> conv3_result_t;
typedef ap_fixed<16,7> weight8_t;
typedef ap_fixed<16,7> bias8_t;
typedef nnet::array<ap_ufixed<16,6,AP_RND_CONV,AP_SAT,0>, 1*1> layer10_t;
typedef ap_fixed<18,8> relu3_table_t;
typedef ap_ufixed<20,8> pool1_accum_t;
typedef nnet::array<ap_ufixed<16,6,AP_RND_CONV,AP_SAT,0>, 1*1> layer11_t;
typedef ap_fixed<41,22> dense1_accum_t;
typedef nnet::array<ap_fixed<41,22>, 28*1> dense1_result_t;
typedef ap_fixed<16,7> weight13_t;
typedef ap_fixed<16,7> bias13_t;
typedef ap_uint<1> layer13_index;
typedef nnet::array<ap_ufixed<16,6,AP_RND_CONV,AP_SAT,0>, 28*1> layer15_t;
typedef ap_fixed<18,8> relu4_table_t;
typedef ap_fixed<28,9> dense2_accum_t;
typedef nnet::array<ap_fixed<28,9>, 5*1> dense2_result_t;
