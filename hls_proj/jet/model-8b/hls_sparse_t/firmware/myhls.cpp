...
void myhls(
    ...
    conv_default_t sparse_arr_feat_conv1_out[N_MAX_PIXELS * 3];
    #pragma HLS ARRAY_PARTITION variable=sparse_arr_feat_conv1_out complete dim=0
    sparse_conv<input_t, conv_default_t, ap_uint<10>, weight2_t, bias2_t, N_MAX_PIXELS, 1, 3, 5>(sparse_arr_feat_reduce_out, sparse_arr_feat_conv1_out, sparse_arr_hash_reduce_out, w2, b2); // sparse conv1
    ...
    sparse_relu<conv_default_t, model_default_t, N_MAX_PIXELS, 3>(sparse_arr_feat_conv1_out, sparse_arr_feat_act1_out); // sparse relu1

    conv_default_t sparse_arr_feat_conv2_out[N_MAX_PIXELS * 2];
    #pragma HLS ARRAY_PARTITION variable=sparse_arr_feat_conv2_out complete dim=0
    sparse_conv<model_default_t, conv_default_t, ap_uint<10>, weight5_t, bias5_t, N_MAX_PIXELS, 3, 2, 5>(sparse_arr_feat_act1_out, sparse_arr_feat_conv2_out, sparse_arr_hash_reduce_out, w5, b5); // sparse conv2
    ...
    sparse_relu<conv_default_t, model_default_t, N_MAX_PIXELS, 2>(sparse_arr_feat_conv2_out, sparse_arr_feat_act2_out); // sparse relu2

    conv_default_t sparse_arr_feat_conv3_out[N_MAX_PIXELS * 1];
    #pragma HLS ARRAY_PARTITION variable=sparse_arr_feat_conv3_out complete dim=0
    sparse_conv<model_default_t, conv_default_t, ap_uint<10>, weight8_t, bias8_t, N_MAX_PIXELS, 2, 1, 5>(sparse_arr_feat_act2_out, sparse_arr_feat_conv3_out, sparse_arr_hash_reduce_out, w8, b8); // sparse conv3

    model_default_t sparse_arr_feat_act3_out[N_MAX_PIXELS * 1];
    #pragma HLS ARRAY_PARTITION variable=sparse_arr_feat_act3_out complete dim=0
    sparse_relu<conv_default_t, model_default_t, N_MAX_PIXELS, 1>(sparse_arr_feat_conv3_out, sparse_arr_feat_act3_out); // sparse relu3
    ...
    sparse_pooling_avg<model_default_t, model_default_t, ap_uint<10>, N_MAX_PIXELS, 1, 2>(sparse_arr_feat_act3_out, sparse_arr_feat_pool1_out, sparse_arr_hash_reduce_out, sparse_arr_hash_pool1_out); // sparse pool1

    model_default_t flatten_out[12 * 12 * 1];
    #pragma HLS ARRAY_PARTITION variable=flatten_out complete dim=0
    sparse_flatten<model_default_t, ap_uint<10>, 12, 12, 1, N_MAX_PIXELS>(sparse_arr_feat_pool1_out, sparse_arr_hash_pool1_out, flatten_out); // sparse flatten
