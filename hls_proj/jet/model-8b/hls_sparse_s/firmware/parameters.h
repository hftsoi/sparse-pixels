...
struct config2 : nnet::conv2d_config {
    ...
    static const unsigned pad_bottom = 4;
    ...
    static const unsigned filt_height = 9;
    ...
    static const unsigned min_height = 56;
    static const unsigned min_width = 56;
...
struct relu_config4 : nnet::activ_config {
    static const unsigned n_in = 9408;
...
struct config10 : nnet::dense_config {
    ...
    static const unsigned strategy = nnet::latency;
    static const unsigned reuse_factor = 1;
    static const unsigned n_zeros = 119;
    static const unsigned n_nonzeros = 3801;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    static const bool store_weights_in_bram = false;
...
struct config13 : nnet::dense_config {
    ...
    static const unsigned n_nonzeros = 98;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    static const bool store_weights_in_bram = false;
