...
typedef nnet::array<ap_fixed<24,14>, 3*1> conv1_result_t;
typedef ap_fixed<8,5> weight2_t;
typedef ap_fixed<8,5> bias2_t;
typedef nnet::array<ap_ufixed<8,4,AP_RND_CONV,AP_SAT,0>, 3*1> layer4_t;
typedef ap_fixed<18,8> relu1_table_t;
typedef nnet::array<ap_ufixed<8,4,AP_RND_CONV,AP_SAT,0>, 3*1> layer17_t;
typedef ap_fixed<25,18> conv2_accum_t;
typedef nnet::array<ap_fixed<25,18>, 1*1> conv2_result_t;
typedef ap_fixed<8,5> weight5_t;
typedef ap_fixed<8,5> bias5_t;
typedef nnet::array<ap_ufixed<8,4,AP_RND_CONV,AP_SAT,0>, 1*1> layer7_t;
typedef ap_fixed<18,8> relu2_table_t;
typedef ap_ufixed<16,8> pool1_accum_t;
typedef nnet::array<ap_ufixed<8,4,AP_RND_CONV,AP_SAT,0>, 1*1> layer8_t;
typedef ap_fixed<25,18> dense1_accum_t;
typedef nnet::array<ap_fixed<25,18>, 20*1> dense1_result_t;
typedef ap_fixed<8,5> weight10_t;
typedef ap_fixed<8,5> bias10_t;
typedef ap_uint<1> layer10_index;
typedef nnet::array<ap_ufixed<8,4,AP_RND_CONV,AP_SAT,0>, 20*1> layer12_t;
typedef ap_fixed<18,8> relu3_table_t;
typedef ap_fixed<22,15> dense2_accum_t;
typedef nnet::array<ap_fixed<22,15>, 5*1> dense2_result_t;
