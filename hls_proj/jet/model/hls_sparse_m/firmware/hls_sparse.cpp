...
void hls_sparse(
    ...
    sparse_conv<model_default_t, model_default_t, ap_uint<10>, weight5_t, bias5_t, N_MAX_PIXELS, 2, 2>(sparse_arr_feat_act1_out, sparse_arr_feat_conv2_out, sparse_arr_hash_reduce_out, w5, b5); // sparse conv2
    ...
    model_default_t sparse_arr_feat_conv3_out[N_MAX_PIXELS * 1];
    #pragma HLS ARRAY_PARTITION variable=sparse_arr_feat_conv3_out complete dim=0
    sparse_conv<model_default_t, model_default_t, ap_uint<10>, weight9_t, bias9_t, N_MAX_PIXELS, 2, 1>(sparse_arr_feat_pool1_out, sparse_arr_feat_conv3_out, sparse_arr_hash_pool1_out, w9, b9); // sparse conv3
    ...
    sparse_relu<model_default_t, model_default_t, N_MAX_PIXELS, 1>(sparse_arr_feat_conv3_out, sparse_arr_feat_act3_out); // sparse relu3
