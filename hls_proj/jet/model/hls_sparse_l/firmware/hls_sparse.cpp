...
void hls_sparse(
    ...
    sparse_conv<input_t, conv_default_t, ap_uint<10>, weight2_t, bias2_t, N_MAX_PIXELS, 1, 3>(sparse_arr_feat_reduce_out, sparse_arr_feat_conv1_out, sparse_arr_hash_reduce_out, w2, b2); // sparse conv1
    ...
    sparse_conv<model_default_t, conv_default_t, ap_uint<10>, weight6_t, bias6_t, N_MAX_PIXELS, 3, 1>(sparse_arr_feat_pool1_out, sparse_arr_feat_conv2_out, sparse_arr_hash_pool1_out, w6, b6); // sparse conv2
    ...
    sparse_flatten<model_default_t, ap_uint<10>, 10, 10, 1, N_MAX_PIXELS>(sparse_arr_feat_act2_out, sparse_arr_hash_pool1_out, flatten_out); // sparse flatten
