...
typedef ap_fixed<37,18> conv1_accum_t;
typedef ap_fixed<37,18> conv1_result_t;
...
typedef ap_fixed<37,18> conv2_accum_t;
...
typedef ap_fixed<39,20> dense2_accum_t;
typedef ap_fixed<39,20> dense2_result_t;
