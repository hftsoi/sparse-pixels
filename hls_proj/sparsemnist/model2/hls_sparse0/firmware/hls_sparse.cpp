...
void hls_sparse(
    ...
    if (!loaded_weights) {
        ...
        nnet::load_weights_from_txt<weight11_t, 25600>(w11, "w11.txt");
        nnet::load_weights_from_txt<bias11_t, 128>(b11, "b11.txt");
        nnet::load_weights_from_txt<weight14_t, 1280>(w14, "w14.txt");
    ...
    nnet::dense<layer9_t, dense1_result_t, config11>(flatten_out, layer11_out, w11, b11); // dense1
