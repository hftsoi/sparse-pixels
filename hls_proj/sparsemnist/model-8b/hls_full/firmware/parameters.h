...
struct config17 : nnet::padding2d_config {
    ...
    static const unsigned out_height = 54;
    static const unsigned out_width = 54;
...
struct config2 : nnet::conv2d_config {
    ...
    static const unsigned in_height = 54;
    static const unsigned in_width = 54;
    static const unsigned n_chan = 1;
    ...
    static const unsigned min_height = 54;
    static const unsigned min_width = 54;
    static const ap_uint<filt_height * filt_width> pixels[min_height * min_width];
    static const unsigned n_partitions = 2304;
...
struct config11 : nnet::dense_config {
    ...
    static const unsigned n_nonzeros = 3852;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    static const bool store_weights_in_bram = false;
...
struct config14 : nnet::dense_config {
    ...
    static const unsigned n_nonzeros = 358;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    static const bool store_weights_in_bram = false;
