...
typedef nnet::array<ap_fixed<22,7>, 3*1> conv2_result_t;
...
typedef nnet::array<ap_fixed<24,9>, 36*1> dense1_result_t;
typedef ap_fixed<8,1> weight11_t;
typedef ap_fixed<8,1> bias11_t;
typedef ap_uint<1> layer11_index;
typedef nnet::array<ap_ufixed<8,0,AP_RND_CONV,AP_SAT,0>, 36*1> layer13_t;
