...
typedef ap_fixed<17,7> conv1_accum_t;
typedef ap_fixed<6,1> conv1_result_t;
...
typedef ap_fixed<6,1> conv2_result_t;
...
typedef ap_fixed<19,8> dense1_result_t;
