...
void hls_sparse(
    ...
    if (!loaded_weights) {
        ...
        nnet::load_weights_from_txt<weight6_t, 36>(w6, "w6.txt");
        nnet::load_weights_from_txt<bias6_t, 2>(b6, "b6.txt");
        nnet::load_weights_from_txt<weight11_t, 3200>(w11, "w11.txt");
    ...
    sparse_flatten<model_default_t, ap_uint<10>, 5, 5, 2, N_MAX_PIXELS>(sparse_arr_feat_pool2_out, sparse_arr_hash_pool2_out, flatten_out); // sparse flatten
